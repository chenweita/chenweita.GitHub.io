...
5.4.1 创建Update
地址：https://github.com/facebook/react/blob/1fb18e22ae66fdb1dc127347e169e73948778e5a/packages/react-reconciler/src/ReactFiberReconciler.new.js#L251
...
6.1.6 计算state
1. 组件render时，useState返回的值为更新后的结果，即一个完整的useState
...
## 与vue的区别
1. 两头对比，先前置后后置，因为fiber结构导致的
2. v-dom：vue父元素知道有几个子元素，react不知
3. 最长递增子序列 提高diff效率